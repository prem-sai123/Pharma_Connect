...
mixin _$OrdersState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(List<MyOrder> data) success,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(List<MyOrder> data)? success,
...
class _$SuccessImpl implements _Success {
  const _$SuccessImpl(final List<MyOrder> data) : _data = data;

  final List<MyOrder> _data;
  @override
  List<MyOrder> get data {
...
abstract class _Success implements OrdersState {
  const factory _Success(final List<MyOrder> data) = _$SuccessImpl;
